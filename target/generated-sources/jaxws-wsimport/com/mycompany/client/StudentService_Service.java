 ...
 * 
 */
@WebServiceClient(name = "StudentService", targetNamespace = "http://service.mycompany.com/", wsdlLocation = "http://localhost:8080/service/StudentService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName STUDENTSERVICE_QNAME = new QName("http://service.mycompany.com/", "StudentService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/service/StudentService?wsdl");
    ...
    public StudentService getStudentServicePort() {
        return super.getPort(new QName("http://service.mycompany.com/", "StudentServicePort"), StudentService.class);
    }
    ...
    public StudentService getStudentServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.mycompany.com/", "StudentServicePort"), StudentService.class, features);
    }
