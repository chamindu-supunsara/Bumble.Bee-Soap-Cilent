 ...
 * 
 */
@WebServiceClient(name = "CustomerService", targetNamespace = "http://Services.service.mycompany.com/", wsdlLocation = "http://localhost:8080/service/CustomerService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CUSTOMERSERVICE_QNAME = new QName("http://Services.service.mycompany.com/", "CustomerService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/service/CustomerService?wsdl");
    ...
    public CustomerService getCustomerServicePort() {
        return super.getPort(new QName("http://Services.service.mycompany.com/", "CustomerServicePort"), CustomerService.class);
    }
    ...
    public CustomerService getCustomerServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://Services.service.mycompany.com/", "CustomerServicePort"), CustomerService.class, features);
    }
