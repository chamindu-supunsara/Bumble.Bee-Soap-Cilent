 ...
 * 
 */
@WebServiceClient(name = "OrderService", targetNamespace = "http://Services.service.mycompany.com/", wsdlLocation = "http://localhost:8080/service/OrderService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName ORDERSERVICE_QNAME = new QName("http://Services.service.mycompany.com/", "OrderService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/service/OrderService?wsdl");
    ...
    public OrderService getOrderServicePort() {
        return super.getPort(new QName("http://Services.service.mycompany.com/", "OrderServicePort"), OrderService.class);
    }
    ...
    public OrderService getOrderServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://Services.service.mycompany.com/", "OrderServicePort"), OrderService.class, features);
    }
